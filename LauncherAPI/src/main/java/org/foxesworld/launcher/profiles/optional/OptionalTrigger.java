...
import org.foxesworld.launcher.profiles.optional.triggers.JavaTrigger;
...
public class OptionalTrigger {
    ...
    public org.foxesworld.launcher.profiles.optional.triggers.OptionalTrigger toTrigger() {
        switch (type) {
            case JAVA_VERSION: {

package org.foxesworld.launcher.client.gui.scenes.serverinfo;
...
import org.foxesworld.launcher.client.gui.scenes.servermenu.ServerButtonComponent;
...
import org.foxesworld.launcher.request.auth.SetProfileRequest;
...
public class ServerInfoScene extends AbstractScene {
    ...
    public void reset() {
        ...
        LookupHelper.<Labeled>lookup(layout, "#money").setText(application.stateService.getGetBalance());

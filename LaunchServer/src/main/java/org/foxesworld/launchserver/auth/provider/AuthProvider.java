...
public abstract class AuthProvider implements AutoCloseable {
     ...
     * @throws Exception Throws an exception {@link AuthException} {@link org.foxesworld.utils.HookException} if the verification script returned a meaningful error

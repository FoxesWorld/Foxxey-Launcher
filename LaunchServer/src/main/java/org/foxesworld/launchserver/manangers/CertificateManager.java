...
public class CertificateManager {
    ...
    public void readTrustStore(Path dir) throws IOException, CertificateException {
        if (!IOHelper.isDir(dir)) {
            ...
            try {
                URL inBuildCert = IOHelper.getResourceURL("org/foxesworld/launchserver/defaults/BuildCertificate.crt");
            ...
            if (IOHelper.exists(dir.resolve("FoxesCentralRootCA.crt"))) {
                logger.warn("Found old default certificate - 'FoxesCentralRootCA.crt'. Delete...");
                Files.delete(dir.resolve("FoxesCentralRootCA.crt"));
            }
        }

...
public class MysqlClientProfileProvider extends ClientProfileProvider {
    ...
    public MysqlClientProfileProvider(MySQLSourceConfig mySQLHolder, String tableServers, String columnName,
                                      String columnServerAddress, String columnServerPort, String columnSrvImage,
                                      String columnVersion, String columnStory, String columnSrvGroup,
                                      String columnEnabled, String columnClientArgs, String columnMainClass,
                                      String columnJvmArgs) {
    ...
    private void verify() {
        verifyNonNull(mySQLHolder, "mySQLHolder");
        verifyNonNull(columnName, "columnName");
        verifyNonNull(columnServerAddress, "columnServerAddress");
        verifyNonNull(columnServerPort, "columnServerPort");
        verifyNonNull(columnVersion, "columnVersion");
        verifyNonNull(columnStory, "columnStory");
        verifyNonNull(columnSrvGroup, "columnSrvGroup");
        verifyNonNull(columnEnabled, "columnEnabled");
        verifyNonNull(columnClientArgs, "columnClientArgs");
        verifyNonNull(columnMainClass, "columnMainClass");
        verifyNonNull(columnJvmArgs, "columnJvmArgs");
    }

    private void verifyNonNull(Object object, String objectName) {
        if (object == null) {
            throw new RuntimeException("[Verify][ClientProfileProvider] " + objectName + " can't be null");
        }
    }
